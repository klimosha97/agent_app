...
export const Database: React.FC = () => {
  ...
  const dataColumns: TableColumn[] = useMemo(() => ([
    ...
    { key: 'fouls_committed', label: 'Фолы совершённые', sortable: true, align: 'center' },
    { key: 'fouls_suffered', label: 'Фолы против', sortable: true, align: 'center' },
    ...
    { key: 'duels_offensive_success_rate', label: 'Атака удачные, %', sortable: true, align: 'center', format: 'percent' },
